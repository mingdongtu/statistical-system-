        ...
        !function (a) {
            ...
            a.laydate = function (b) {
                ...
                for (var i = 0; i < a.length; i++) {
                    var temp = document.scripts[i].src;
                    if (temp.indexOf('laydate.js') != -1) {
                        c = a[i].src;
                    }
                }
                ...
                var d, e, b = c.query;
                if (a.tagName) {
                    if (d = a.elem ? b(a.elem) : event.target || event.srcElement, !d || d === c.elem)
                        return;
                ...
                c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"), c.each(b(e.box + " .laydate_ym"), function (a, b) {
                    ...
                    c.elem[h.elemv] = "", (c.close(), "function" == typeof c.options.clear && c.options.clear(f))
